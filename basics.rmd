...
To simulate a pair of dice, you will have to distill each die into its essential features. You cannot place a physical object, like a dice, into a computer (well, not without unscrewing some screws), but you can save _information_ about the object in your computer's memory.

Which information should you save? In general, a dice has six important pieces of information: when you roll a die, it can only result in one of six numbers: 1, 2, 3, 4, 5, and 6. You can capture the essential characteristics of a dice by saving the numbers 1, 2, 3, 4, 5, and 6 as a group of values in your computer's memory. 
